...
describe('Cases from app.js', () => {
  ...
  describe('Ben', () => {
    ...
    it('should have favBand as Beastie Boys', () => {
      const Ben = cases.Ben;
  ...
  describe('Sean', () => {
    ...
    it('should have favFood as Pizza', () => {
      const Sean = cases.Sean;
  ...
  describe('Ryan', () => {
    ...
    it('should not have favBook as Harry Potter', () => {
      const Ryan = cases.Ryan;
  ...
  describe('Austen', () => {
    ...
    it('should not have favColor as Gold', () => {
      const Austen = cases.Austen;
  ...
  describe('Ivan', () => {
    ...
    it('should have favActivity as Rock Climbing', () => {
      const Ivan = cases.Ivan;
